                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form action="<?=$_SERVER['PHP_SELF'] ?>" method="post" class="mx-1 mx-md-4">
                    <div class="d-flex flex-row align-items-center mb-4">
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="formUsername" class="form-control" name="username" value="<?=htmlspecialchars(@$inputValues['username']) ?>" oninvalid="setCustomValidity('Unesite korisničko ime.')" autofocus />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="email" id="formEmail" class="form-control" name="email" value="<?=htmlspecialchars(@$inputValues['email']) ?>"  oninvalid="setCustomValidity('Unesite e-mail.')" />
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="password" id="formPassword" class="form-control" name="password" value="<?=htmlspecialchars(@$inputValues['password']) ?>" required oninvalid="setCustomValidity('Unesite lozinku.')" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="formName" class="form-control" name="firstname" value="<?=htmlspecialchars(@$inputValues['firstname']) ?>" required oninvalid="setCustomValidity('Unesite ime.')" />
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="formLastName" name="lastname" class="form-control" value="<?=htmlspecialchars(@$inputValues['lastname']) ?>"  required oninvalid="setCustomValidity('Unesite prezime.')" />
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="date" id="formDate" class="form-control" name="dob" value="<?=htmlspecialchars(@$inputValues['dob']) ?>" required oninvalid="setCustomValidity('Unesite datum.')" />
                      </div>
                    </div>

                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <small id="pwHelp" class="form-text text-muted">Imaš nalog? <a class="reg_link" href="<?=$PATH.'/login.php'?>">Prijavi se</a></small>
                    </div> 
                  ...
                  <?php endif; if ($success): ?> 
                    <div class="d-flex justify-content-center mb-lg-4 alert alert-success" role="alert">
                      <p class="success"><?='Uspešna registracija, redirektujem na login...' ?></p>
                    </div>
                  <?php endif; ?>
                </div>
